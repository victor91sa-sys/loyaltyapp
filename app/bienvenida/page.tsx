      ...
      <main className="min-h-screen bg-[#FAFBFF] flex flex-col items-center justify-center p-8">
        <div className="ficha p-10 text-center max-w-md w-full">
          ...
          <button
            ...
            className="btn-3d btn-3d-azul w-full"
          >
            Volver al registro
          </button>
        </div>
  ...
  return (
    <main className="min-h-screen bg-[#FAFBFF] flex flex-col items-center justify-center p-8">
      <div className="ficha p-10 text-center max-w-md w-full">
        ...
        <h1 className="text-3xl font-bold text-gray-900 mb-3">¡Cuenta confirmada!</h1>
        <p className="text-gray-500 mb-2">Tu programa de lealtad está listo.</p>
        <p className="text-gray-400 text-sm mb-8">Inicia sesión para configurar tu QR y empezar a construir tu comunidad.</p>
        <button
          onClick={() => router.push('/login')}
          className="btn-3d btn-3d-naranja w-full mb-6"
        >
          Ir a mi panel
        </button>
